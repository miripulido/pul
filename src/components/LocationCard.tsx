  ...
  if (location.status === 'coming-soon') {
    return (
      <div className="flex flex-col">
        <div
          className="relative flex items-center justify-center border border-line bg-transparent"
          style={{ aspectRatio: '3 / 2' }}
        >
          <span className="text-eyebrow uppercase tracking-label text-muted/60">
    ...
    <Link href={href} className="group flex flex-col">
      ...
      <div className="mt-5 flex items-start justify-between gap-6">
        <div>
          ...
          <p className="mt-2 text-muted">{location.place}</p>
        </div>
        <span
          aria-hidden
